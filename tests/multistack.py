...
for i in range(0, 10, 1):
    geometry.extend(createLayer(0.3, i))

sources = [
    mp.Source(
        mp.ContinuousSource(frequency=freq), component=mp.Ez, center=mp.Vector3(-200, 0)
    )
]

pml_layers = [mp.PML(500)]
